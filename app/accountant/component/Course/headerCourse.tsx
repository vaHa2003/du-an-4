        ...
        <Col xs={12} sm={12} md={6} className="mb-4">
          <Row className="bg-white d-flex flex-row rounded-lg justify-content-between py-3 rounded-3">
            <Col
              ...
              sm={2}
              md={1}
              className={`d-flex flex-row justify-content-center align-items-center  mb-4 mb-md-0 mb-sm-0 px-0 border-end`}
            >
            ...
            <Col
              ...
              sm={2}
              md={2}
              className=" justify-content-center align-items-center d-flex mb-4 mb-md-0 mb-sm-0 border-end"
            >
              <select
                aria-label="Trạng thái"
                className={`${h.formSelect} border-end`}
              >
            ...
            <Col
              ...
              sm={2}
              md={2}
              className=" justify-content-center align-items-center d-flex border-end"
            >
              <select
                aria-label="Lượt xem"
                className={`${h.formSelect} border-end`}
